...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException {
		...
		Users users=new Users("Rajashree", "Software Engineer");
		
		//java obj to json 
		mapper.writeValue(new File("\\Users\\rajas\\eclipse-workspace\\xworkz\\hibernate\\restapi\\src\\main\\java\\com\\qa\\data\\users.json"), users); 
		...
		closebaleHttpResponse=restClient.post(url, usersJsonInString, headerMap);
