	 ...
	 public static void main(String[] args) {
		//arrayList with duplicate values
		 ArrayList<String> emails=new ArrayList<String>();
			...
			//remove duplicate calling a method removeDuplicates
			
			ArrayList<String> newList=removeDuplicates(emails);
			
			System.out.println(newList);
			
			System.out.println("total elements in arrayList without duplicates "+newList.size());
