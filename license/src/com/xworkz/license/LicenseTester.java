...
public class LicenseTester {
	public static void main(String[] args) {
		...
		impl.save(dto);
		LicenseDTO found=impl.findByIdProofNo("6678 7889 8990");
		System.out.println(found);
		LicenseDTO found1=impl.findByIdProofNo("485330002814");
		System.out.println(found1);
		boolean update=impl.updateByIdProofNo(VehicleType.FOUR_WHEELER, "485330002814");
